        ...
        <div class="container-detail">
            ...
            <div class="main-detail">
                ...
                <div class="price-content">
                            ...
                            <label>Rp.</label> <input type="number"  name="subprice" id="subprice" value="{{ $data->price }}" onkeyup="total()" readonly>
                            ...
                            <div class="wrap-finish">
                                ...
                                <div class="wrap-price">
                                    <label>Rp.</label> <input type="text" name="price" id="price" value="{{ $data->price }}" readonly>
                                </div>
